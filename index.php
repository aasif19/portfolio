...
<head>
   ...
   <title>Portfolio | Aasif Imraan</title>
  ...
  <?php include "contact.php"; ?>  
   ...
   <?php include "exp.php"; ?>  
    ...
    <?php include "project-slider.php"; ?>  
            ...
            <div class="tp-project__area grey-bg pt-60 pb-110 fix">
               <div class="container">
                  <div class="row">
                     <div class="col-xl-6">
                        <div class="tp-project__section-box wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                           <h3 class="tp-section-title">Check Some
                              Of Our Recent Work.</h3>
                        </div>
                     </div>
                  </div>
               </div>
                                       ...
                                       <div class="tp-project__item d-flex align-items-center">
                                          ...
                                          <div class="tp-project__content">
                                             ...
                                             <div class="tp-project__title-box">
                                                <h4 class="tp-project__title-sm"><a href="#">Muckup Design</a></h4>
                                    ...
                                    <div class="tp-project__slider-wrapper">
                                       <div class="tp-project__item d-flex align-items-center">
                                          ...
                                          <div class="tp-project__content">
                                             ...
                                             <div class="tp-project__title-box">
                                                <h4 class="tp-project__title-sm"><a href="#">3d Design</a></h4>
                                                <p>Excepteur sint occaecat cupidatat officia non
                                                   proident, sunt in culpa qui deserunt mollit anim
                                                   id est laborum.
                                                </p>
                                    ...
                                    <div class="tp-project__slider-wrapper">
                                       <div class="tp-project__item d-flex align-items-center">
                                          ...
                                          <div class="tp-project__content">
                                             ...
                                             <div class="tp-project__title-box">
                                                <h4 class="tp-project__title-sm"><a href="#">App Design</a></h4>
                                                <p>Excepteur sint occaecat cupidatat officia non
                                                   proident, sunt in culpa qui deserunt mollit anim
                                                   id est laborum.
                                                </p>
                                    ...
                                    <div class="tp-project__slider-wrapper">
                                       <div class="tp-project__item d-flex align-items-center">
                                          ...
                                          <div class="tp-project__content">
                                             ...
                                             <div class="tp-project__title-box">
                                                <h4 class="tp-project__title-sm"><a href="#">Graphic Design</a></h4>
                                                <p>Excepteur sint occaecat cupidatat officia non
                                                   proident, sunt in culpa qui deserunt mollit anim
                                                   id est laborum.
                                                </p>
